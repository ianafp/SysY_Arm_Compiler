...
@MAX_SIZE = constant i32  zeroinitializer, align 4

@nums = global i32  zeroinitializer, align 4
...
store i32 1, i32*  %4
%5 = ptrtoint [ 4 x[ 4 x i32 ]]* %local to i64
%6 = sext i32 0 to i64
%7 = add i64 %5, %6
...
store i32 3, i32*  %12
%13 = ptrtoint [ 4 x[ 4 x i32 ]]* %local to i64
%14 = mul i32 16, 0
%15 = mul i32 0, 4
%16 = add i32 %14, %15
...
store i32 1, i32*  %19
%20 = ptrtoint [ 4 x[ 4 x i32 ]]* %local to i64
%21 = mul i32 16, 1
%22 = mul i32 0, 4
%23 = add i32 %21, %22
%24 = sext i32 %23 to i64
...
%26 = inttoptr i64 %25 to i32*
store i32 2, i32*  %26
%27 = ptrtoint [ 4 x[ 4 x i32 ]]* %local to i64
%28 = mul i32 16, 1
%29 = mul i32 2, 4
%30 = add i32 %28, %29
...
store i32 3, i32*  %33
%34 = ptrtoint [ 4 x[ 4 x i32 ]]* %local to i64
%35 = mul i32 16, 2
%36 = mul i32 3, 4
%37 = add i32 %35, %36
